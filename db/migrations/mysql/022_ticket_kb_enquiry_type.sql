-- MySQL/MariaDB port of postgresql/022_ticket_kb_enquiry_type.sql; keep the two in step.
-- REQ-225 (Knowledge-Base-Module-Plan.md v0.1 section 10, a decision,
-- not just an open question): tickets get the same enquiry-type
